...
public class ImportExcel {
     ...
     * @throws IOException
     */
    private ImportExcel(String fileName, InputStream is, int headerNum, int sheetIndex) throws IOException {
                ...
                if (val != null) {
                    ...
                    try {
                        if (ef.fieldType() != Class.class) {
                            ...
                            if (StringUtils.endsWith(s, ".0000")) {
                                val = StringUtils.substringBefore(s, ".0000");
                            } else {
